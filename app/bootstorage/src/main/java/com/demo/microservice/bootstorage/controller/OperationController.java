...
public class OperationController {
    ...
    private Counter createdOperationsCounter;
    
    @PostConstruct
    public void initMetrics() {
        createdOperationsCounter = meterRegistry.counter("bootstorage_operations_created_total");
    }
    ...
    public OperationDto createOperation(@RequestBody @Valid CreateOperationRequest createOperationRequest){
        ...
        if (operation != null) {
            createdOperationsCounter.increment();  // Increment counter
