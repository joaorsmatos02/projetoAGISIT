<template>
  <div class="calculator" id="app">
    <h1>Calculator</h1>
    <p>Created By - Arpit Khandelwal & <b style="color:green;">Enhanced by Group 9 (AGISIT)</b> </p>
    <div class="display">
      <p>
    ...
    <p class="row">
      ...
      <button v-on:click="buttonclicked('mod')">mod</button>
    </p>
    <p class="row">
  ...
  methods: {
	      calculate: async function (num1, num2, opr, callback) {
            ...
            case 'mod':
                  ...
                  try{
                    console.log('Hitting web api for modulos')
                    const response = await HappyService.getModulosResult(num1, num2);
                    console.log('Returned result=' + response.data);
                    callback(response.data);
                  } catch(e){
                    callback(e);
            ...
            var operation = this.calculation.match(/[+]|[-]|[x]|[/]|mod/g);
            var result;
